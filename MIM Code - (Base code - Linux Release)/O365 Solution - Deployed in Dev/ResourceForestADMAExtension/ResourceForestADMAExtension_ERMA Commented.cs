...
namespace Mms_ManagementAgent_ResourceForestADMAExtension
{
    ...
    public class MAExtensionObject : IMASynchronization
    {
        ...
        Hashtable afvalhash;
		//HCM Comments- ERMA retired. commenting below code.		
       ...
       // string[] arrERMASystemIDs;
        ...
        void IMASynchronization.Initialize()
        {
            ...
            try
            {
                ...
                #region Reading Recipient Policies
                ...
                //Read Recipient policies in Valuecollection
                ...
                #region Reading Allowed Domains
                StreamReader objStreamReader;
                string input;

                //Reading Allowed Domains from file
                ...
                //setting allowed doamins into in Valuecollection
				...
				//HCM Comments- ERMA retired. commenting below code.
                #region Reading ERMASystemIDs
                //HCM Comments - SHould we remove this logic to read ERMASystemIDs. Currently used to set EA8 logic.
        ...
        void IMASynchronization.MapAttributesForImport(string FlowRuleName, CSEntry csentry, MVEntry mventry)
        {
            ...
            //Checking for ImportRUle flows . Ex- ImportRule:mailNickname:mailNickname
                ...
                switch (FlowRuleName)
                {
                    ...
                    case "cd.user:homeMTA,msExchRecipientTypeDetails->mv.person:Exchnge_crt_dt":
                        ...
                        if (csentry["homeMTA"].IsPresent && csentry["msExchRecipientTypeDetails"].IsPresent
                           && csentry["msExchRecipientTypeDetails"].Value == "2")
                        {
        ...
        void IMASynchronization.MapAttributesForExport(string FlowRuleName, MVEntry mventry, CSEntry csentry)
        {
            ...
            //UPN set for the user translated out of XML file
				...
				//HCM Comments- ERMA retired. TBD commenting below code.
                    ...
                    if (mventry["Exch_Trans_CD"].IsPresent)
                    {
                        switch ((mventry["Exch_Trans_CD"].Value))
                        {
                            ...
                            case "10":
                                ...
                                break;
                            case "2": // HCM Comments - day 0 transition from mailbox to None or contact . it sets the extensionAttribute10 (msExchtransitionDate) to trigger the trans code logic in SAD MA for next cycle
