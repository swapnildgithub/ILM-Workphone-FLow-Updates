                    ...
                    case "person":
                        {
                            ...
                            {
                                tnmsUserMA = mventry.ConnectedMAs["TNMS User MA"];
                                connectors = tnmsUserMA.Connectors.Count;
                                ...
                                if (sadconnectors == 1) //Record exists in the SAD
                                {
                                    ...
                                    if (connectors == 0) //Account doesn't exist in PD yet, to be inserted 
                                    {
                                        ...
                                        if (CommonLayer.ISSysAccessFlagSet(mventry))
                                        {
                                            ...
                                            if (mventry["employeeType"].IsPresent)
                                            {
                                                ...
                                                {
                                                    csentry = tnmsUserMA.Connectors.StartNewConnector("person");
                                    ...
                                    {
                                        csentry = tnmsUserMA.Connectors.ByIndex[0];
