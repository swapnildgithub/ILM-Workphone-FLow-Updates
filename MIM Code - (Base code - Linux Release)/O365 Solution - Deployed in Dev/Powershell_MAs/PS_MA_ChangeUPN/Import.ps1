...
$MsolObjects | ForEach-Object {            
    ...
    switch ($MsolObj.Type) {            
        'User' {
                        ...
                        $extensionAttribute4 = ""
                        IF([string]::IsNullOrWhiteSpace($MsolObj.extensionAttribute4)) 
                        
                        { 
                          $extensionAttribute4 = "1000"         
            ...
            Add-FIMCSAttributeChange -Add -Name 'IsEmailDomainChange' -Value $MsolObj.saMAccountName -PassThru            
